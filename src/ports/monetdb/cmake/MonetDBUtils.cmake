# Define MonetDB feature macros
#
function(define_monetdb_features IN_VERSION OUT_FEATURES)
...
endfunction(define_monetdb_features)
...
#
# If the user specifies at least one ${PORT_UC}_X_Y_MT_CONFIG, we only build
...
# It sets one ${PORT_UC}_X_Y_MT_CONFIG to the path to MT_config that was found.
#
function(determine_target_versions OUT_VERSIONS)
    ...
    foreach(VERSION ${SUPPORTED_VERSIONS})
        ...
        if(DEFINED ${PORT_UC}_${VERSION_UNDERSCORE}_MT_CONFIG)
    ...
    if(NOT DEFINED ${OUT_VERSIONS})
        ...
        if(_POS EQUAL -1)
            ...
            message(STATUS "Found monetdb_config at "
                    "\"${${PORT_UC}_MT_CONFIG}\", but it points to ${PORT} version "
            ...
            # Side effect:
            set(${PORT_UC}_${VERSION_UNDERSCORE}_MT_CONFIG
                    "${${PORT_UC}_MT_CONFIG}" PARENT_SCOPE)
    ...
    # ${PORT_UC}_${_VERSION_UNDERSCORE}_MT_CONFIG might have been set earlier!
    # (the side effect)
